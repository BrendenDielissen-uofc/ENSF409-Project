...
public class Inventory {
     ...
     */
	/*
//	 * public static void main(String[] args) throws SQLException { Inventory myJDBC
//	 * = new Inventory("jdbc:mysql://localhost/inventory", "scm", "ensf409");
//	 * myJDBC.initializeConnection(); Furniture[] testLamps =
